...
<!--        <img width="32" src="static/img/logo.png"  alt=""/>-->
      ...
      <div v-if="layout === 'head'" class="global-header-menu">
        <i-menu style="height: 64px; line-height: 64px;background: #491b74;color: white" class="system-top-menu" :theme="theme" mode="horizontal" :menuData="menuData" @select="onSelect"/>
      </div>
